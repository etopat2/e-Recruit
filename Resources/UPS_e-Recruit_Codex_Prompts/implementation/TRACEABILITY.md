...
| NFR-SEC-001..007 / AC-10 | RBAC/MFA, private uploads, encryption boundaries, security headers, rate limits, retention commands, backup/restore, incident/pilot/rollback runbooks and non-root minimized images | 54 backend tests, 30 browser tests, dependency/history/container scans, local restore and k6 production-path smoke | Implemented and tested; independent security/privacy, production restore/load and pilot sign-off required |
